     ...
     <tbody>
      ...
      <tr>
       <td height="30" align="right" class="wizard_tail">
        &nbsp;
        <input type="submit" name="wizardstep2_back" value="<#wizard_step2_select_008#>">
        &nbsp;
        <input type="submit" name="wizardstep2_next" value="<#wizard_step2_select_009#>">
        &nbsp;
