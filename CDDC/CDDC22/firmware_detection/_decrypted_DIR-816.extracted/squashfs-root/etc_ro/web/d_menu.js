...
var index = 0;
SetupMenu[index++]=new Gitem(CSetup, "<#menu.ap_064#>", "d_wizard_step1_start.asp", 1, "d_setuphelp.asp", -1);
SetupMenu[index++]=new Gitem(CSetup, "<#menu.ap_019#>", "d_lan.asp", 1, "d_setuphelp.asp", -1);
if(!(("<% getCfgZero(1,"ApCliEnable");%>"==1)||("<% getCfg2Zero(1,"ApCliEnable");%>"==1))){
	SetupMenu[index++]=new Gitem(CSetup, "<#menu.ap_068#>", "d_wan.asp", 1, "d_setuphelp.asp", -1);
}
//SetupMenu[index++]=new Gitem(CSetup, "<#menu.ap_134#>", "d_pptp.asp", 1, "d_setuphelp.asp", -1);
//SetupMenu[index++]=new Gitem(CSetup, "<#menu.ap_135#>", "d_l2tp.asp", 1, "d_setuphelp.asp", -1);
index = 0;
WirelessMenu[index++]=new Gitem(CWireless, "<#menu.ap_027#>", "d_wlan_basic.asp", 1, "d_wlanhelp.asp", -1);
WirelessMenu[index++]=new Gitem(CWireless, "<#menu.ap_076#>", "d_wlwps_step1.asp", 1, "d_wlanhelp.asp", -1);
WirelessMenu[index++]=new Gitem(CWireless, "<#menu.ap_077#>", "d_wladvanced.asp", 1, "d_wlanhelp.asp", -1);
WirelessMenu[index++]=new Gitem(CWireless, "<#menu.ap_078#>", "d_wlrepeater.asp", 1, "d_wlanhelp.asp", -1);
index = 0;
Wireless5GMenu[index++]=new Gitem(CWireless5g, "<#menu.ap_027#>", "d_wl5basic.asp", 1, "d_wlanhelp.asp", -1);
Wireless5GMenu[index++]=new Gitem(CWireless5g, "<#menu.ap_076#>", "d_wl5wps_step1.asp", 1, "d_wlanhelp.asp", -1);
Wireless5GMenu[index++]=new Gitem(CWireless5g, "<#menu.ap_077#>", "d_wl5advanced.asp", 1, "d_wlanhelp.asp", -1);
Wireless5GMenu[index++]=new Gitem(CWireless5g, "<#menu.ap_078#>", "d_wl5repeater.asp", 1, "d_wlanhelp.asp", -1);
index = 0;
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_060#>", "d_acl.asp", 1, "d_advhelp.asp", -1);
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_085#>", "d_nat_portrigger.asp", 1, "d_advhelp.asp", -1);
AdvMenu[index++]=new Gitem(CAdvanced, "DMZ", "d_fw-dmz.asp", 1, "d_advhelp.asp", -1);
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_087#>", "d_url_nokeyword.asp", 1, "d_advhelp.asp", -1);
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_094#>", "d_ddns.asp", 1, "d_advhelp.asp", -1);
//AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_095#>", "d_netsniper.asp", 1, "d_advhelp.asp", -1);
if(PortMapping) {
 AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_096#>", "d_portmap.asp", 1, "d_advhelp.asp", -1);
}
if(showTrafficShaping){
 AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_100#>", "d_ipqostc_gen_ap.asp", 1, "d_advhelp.asp", -1);
}
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_132#>", "d_upnp.asp", 1, "d_advhelp.asp", -1);
//AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_131#>", "d_telnet.asp", 1, "d_advhelp.asp", -1);
if(ShowTR069=='1') {
 AdvMenu[index++]=new Gitem(CAdvanced, "TR-069", "d_tr069.asp", 1, "d_advhelp.asp", -1);
}
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_050#>", "d_virtualSrv.asp", 1, "d_advhelp.asp", -1);
AdvMenu[index++]=new Gitem(CAdvanced, "<#menu.ap_107#>", "d_cups.asp", PrintServer, "d_advhelp.asp", -1);
AdvMenu[index++]=new Gitem(CAdvanced, "ALG", "d_alg.asp", 1, "d_advhelp.asp", -1);
index = 0;
MaintainMenu[index++]=new Gitem(CMaintain, "<#menu.ap_110#>", "d_reboot.asp", 1, "d_mainhelp.asp", -1);
MaintainMenu[index++]=new Gitem(CMaintain, "<#menu.ap_111#>", "d_upload.asp", 1, "d_mainhelp.asp", -1);
MaintainMenu[index++]=new Gitem(CMaintain, "<#menu.ap_112#>", "d_saveconf.asp", 1, "d_mainhelp.asp",-1);
MaintainMenu[index++]=new Gitem(CMaintain, "<#menu.ap_113#>", "d_userconfig.asp", 1, "d_mainhelp.asp",-1);
MaintainMenu[index++]=new Gitem(CMaintain, "<#menu.ap_114#>", "d_time.asp", InternetTime, "d_mainhelp.asp", -1);
index = 0;
StatMenu[index++]=new Gitem(CStatus, "<#menu.ap_118#>", "d_status.asp", 1, "d_statushelp.asp", -1);
StatMenu[index++]=new Gitem(CStatus, "<#menu.ap_119#>", "d_dhcptbl.asp", 1, "d_statushelp.asp", -1);
StatMenu[index++]=new Gitem(CStatus, "<#menu.ap_121#>", "d_stats.asp", 1, "d_statushelp.asp", -1);
index = 0;
HelpMenu[index++]=new Gitem(CHelp, "<#menu.ap_124#>", "d_helpmenu.asp", 1, "", -1);
HelpMenu[index++]=new Gitem(CHelp, "<#menu.ap_125#>", "d_helpsetup.asp", 1, "", -1);
HelpMenu[index++]=new Gitem(CHelp, "<#menu.ap_138#>", "d_helpwlan.asp", 1, "", -1);
HelpMenu[index++]=new Gitem(CHelp, "<#menu.ap_127#>", "d_helpadv.asp", 1, "", -1);
HelpMenu[index++]=new Gitem(CHelp, "<#menu.ap_128#>", "d_helpmain.asp", 1, "", -1);
HelpMenu[index++]=new Gitem(CHelp, "<#menu.ap_129#>", "d_helpstatusinfo.asp", 1, "", -1);
...
index = 0;
TabMenu[index++] =new Gtab("<#menu.ap_125#>", setup);
TabMenu[index++] =new Gtab("<#menu.ap_126#>", wlan);
TabMenu[index++] =new Gtab("<#menu.ap_130#>", wlan5g);
TabMenu[index++] =new Gtab("<#menu.ap_127#>", adv);
TabMenu[index++] =new Gtab("<#menu.ap_128#>", maintenace);
TabMenu[index++] =new Gtab("<#menu.ap_129#>", status);
TabMenu[index++] =new Gtab("<#menu.ap_133#>", help);
...
function Write_Folder_Images()
{
	...
	if (lang == "English") {
		if(ie5){
			...
			var top1_5g = '<td width=184 class=';//154
		}else{
...
function mainTableStart()
{
 ...
 document.write('<td align="right" height="30" colspan="3" bgcolor="#404343"><#product_info_000#>' + HardwareVer + '&nbsp;&nbsp;&nbsp;&nbsp;<#product_info_001#>' + FirmwareVer + '&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>')
 document.write('<tr>');
 document.write('<td class="product_page" align="left"><#product_info_002#> ' + ModemVer+ '</td>')
 document.write('</tr>');
 document.write('<tr>');
 document.write('<td align="left"><a href="http://www.dlink.com.tw/" target="_blank"><img src="../images/head_01.gif" border="0"></a></td>');
...
function Footer()
{
 ...
 document.write('<tr><td><#product_info_003#></td></tr>');
 document.write('</table>');
}
...
function wizardHead()
{
 ...
 '<TABLE id="header_container" width="980"><TR><TD align=left width="200"><#menu.ap_001#> ' + ModemVer+ '</TD><TD align=right width="50"></TD>' +
 '<TD align=right width="690"><#menu.ap_002#>:1.07</TD></TR></TABLE>');
...
linkset[0]+='<li><div><a href="d_lan.asp"><#menu.ap_019#></a></div>';
linkset[0]+='<li><div><a href="d_dhcpd_nocheck_lanip.asp"><#menu.ap_020#></a></div>';
linkset[0]+='<li><div><a href="d_dhcpip_nocheck_lanip.asp"><#menu.ap_021#></a></div>';
linkset[0]+='</li></ul></div>';
...
linkset[2]+='<li><div><a href="d_wlbasic.asp"><#menu.ap_027#></a></div>';
linkset[2]+='<li><div><a href="d_wlwpa_mbssid.asp"><#menu.ap_028#></a></div>';
linkset[2]+='</li></ul></div>';
linkset[3]='<div id=sidenav><ul>';
linkset[3]+='<li><div><a href="d_wladvanced.asp"><#menu.ap_029#></a></div>';
linkset[3]+='<li><div><a href="d_wlactrl.asp"><#menu.ap_030#></a></div>';
...
linkset[3]+='<li><div><a href="d_wlwds_enc.asp"><#menu.ap_034#></a></div>';
linkset[3]+='</li></ul></div>';
linkset[4]='<div id=sidenav><ul>';
linkset[4]+='<li><div><a href="d_fw-ipportfilter_adv.asp"><#menu.ap_035#></a></div>';
linkset[4]+='</li></ul></div>';
linkset[5]='<div id=sidenav><ul>';
if(PortMapping) {
 linkset[5]+='<li><div><a href="d_portmap.asp"><#menu.ap_037#></a></div>';
}
linkset[5]+='<li><div><a href="d_igmproxy.asp"><#menu.ap_038#></a></div>';
if(showTrafficShaping){
...
linkset[6]+='<li><div><a href="d_routing.asp"><#menu.ap_048#></a></div>';
linkset[6]+='</li></ul></div>';
linkset[7]='<div id=sidenav><ul>';
linkset[7]+='<li><div><a href="d_virtualSrv.asp"><#menu.ap_050#></a></div>';
linkset[7]+='</li></ul></div>';
...
linkset[8]+='<li><div><a href="d_diag-test.asp"><#menu.ap_059#></a></div>';
linkset[8]+='</li></ul></div>';
linkset[9]='<div id=sidenav><ul>';
linkset[9]+='<li><div><a href="d_acl.asp"><#menu.ap_060#></a></div>';
linkset[9]+='</li></ul></div>';
