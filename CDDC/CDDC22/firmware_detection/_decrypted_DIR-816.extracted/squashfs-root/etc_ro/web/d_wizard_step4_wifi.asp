...
function saveChanges()
{
 /*if(!checkSpecialCharExcludeSpace(document.form2WizardStep4.wizardstep4_ssid.value,1))
 {
  ...
  return false;
	...
	if(includeChinese(document.form2WizardStep4.wizardstep4_ssid.value))
	{
		alert('<#redirect_071#>');
		document.form2WizardStep4.wizardstep4_ssid.focus();
		return false;
 ...
 if (document.form2WizardStep4.wizardstep4_sec[1].checked)
 {
  ...
  if (str.length != 64)
  {
   if (str.length < 8)
   {
    alert('<#wizard_step4_wifi_001#>');
    document.form2WizardStep4.show_wizardstep4_pskpwd.focus();
    return false;
   }
   if (str.length > 63)
   {
    alert('<#wizard_step4_wifi_002#>');
    document.form2WizardStep4.show_wizardstep4_pskpwd.focus();
    return false;
   }
   /*if(!isValidWPAPasswd(str))
   {
     alert('<#wizard_step4_wifi_003#>');
    return false;
   }*/
      ...
      <tr>
       <td colspan="2">
        ...
        <table width="430" align="center" border="0" class="space">
         <tbody>
          <tr>
           <td class=form_label_left><#wizard_step4_wifi_010#>
           </td>
          ...
          <tr>
           <td class=form_label_left><#wizard_step4_wifi_011#></td>
...
value="<% getCfgGeneral(1, "SSID1"); %>">
          ...
          <tr style="display:none">
           <td class=form_label_left><#wizard_step4_wifi_012#></td>
           <td class=form_label_right>
          ...
          <tr style="display:none">
           <td class=form_label_left><#wizard_step4_wifi_013#></td>
          ...
          <tr style="display:none">
           <td class=form_label_left><#wizard_step4_wifi_020#></td>
          ...
          <tr style="display:none">
           <td class=form_label_left><#wizard_step4_wifi_021#></td>
           <td class=form_label_right><select size="1" name="wizardstep4_ctlband" onChange="updateChan_channebound()">
            <option value="0"><#wizard_step4_wifi_024#></option>
            <option value="1"><#wizard_step4_wifi_025#></option>
            </select>
           </td>
          </tr>
          <SCRIPT>
         ...
         <tbody>
          ...
          <tr>
           <td id="t_rate" class="Item" colspan="2">
            <#wizard_step4_wifi_026#>
           </td>
          </tr>
          <tr>
           <td class="Item" colspan="2">
            <p style="color:red"><#wizard_step4_wifi_027#>
            </p>
           </td>
          </tr>
          <tr>
           <tr>
            <td class=form_label_left><input type="radio" value="0" name="wizardstep4_sec" onClick="encodeSelection()"></td>
             <td class=form_label_right><#wizard_step4_wifi_028#></td>
           </tr>
           <tr>
           ...
           <tr style="display:none">
            <td class=form_label_left><#wizard_step4_wifi_029#></td>
            <td class=form_label_right><select size="1" name="wizardstep4_pskFormat">
             <option value=0 ><#wizard_step4_wifi_030#></option>
             <option value=1 ><#wizard_step4_wifi_031#> (64 characters)</option>
             </select>
            </td>
           </tr>
           <tr>
            <td class=form_label_left><#wizard_step4_wifi_032#></td>
            <td class=form_label_right><input type=text name="show_wizardstep4_pskpwd" size="25" maxlength="64" value=""> <#wizard_step4_wifi_033#>
       ...
       <td width="276" align="right" class="wizard_tail">
		<script>
			if(!(("<% getCfgZero(1,"ApCliEnable");%>"==1)||("<% getCfg2Zero(1,"ApCliEnable");%>"==1))){//如果关闭无线中继
				document.writeln("<input type=\"submit\" name=\"wizardstep4_back\" value=\"<#wizard_step2_select_008#>\">&nbsp;");
				document.writeln("<input type=\"submit\" name=\"wizardstep4_next\" value=\"<#wizard_step2_select_009#>\" onClick=\"return saveChanges()\">&nbsp;");
			}else{
				document.writeln("<input type=\"submit\" name=\"wizardstep4_back_ignore_wan_setting\" value=\"<#wizard_step2_select_008#>\">&nbsp;");
				document.writeln("<input type=\"submit\" name=\"wizardstep4_next\" value=\"<#wizard_step2_select_009#>\" onClick=\"return saveChanges()\">&nbsp;");
			}
		</script>
