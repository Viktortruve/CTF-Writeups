...
function saveChanges()
{
 /*if(!checkSpecialCharExcludeSpace(document.form2WizardStep54.wizardstep54_ssid.value,1))
 {
  ...
  return false;
	...
	if(includeChinese(document.form2WizardStep54.wizardstep54_ssid.value))
	{
		alert('<#redirect_071#>');
		document.form2WizardStep54.wizardstep54_ssid.focus();
		return false;
...
defaultChan=0;
         ...
         <tbody>
          ...
          <tr>
           ...
           <tr>
            ...
            <td class=form_label_right><input type=text name="show_wizardstep54_pskpwd" size="25" maxlength="64" value=""> <#wizard_step4_wifi_033#>
      ...
      <tr>
       ...
       <td width="276" align="right" class="wizard_tail">
        <input type="submit" name="wizardstep54_back" value="<#wizard_step2_select_008#>">
        &nbsp;
        <input type="submit" name="wizardstep54_next" value="<#wizard_step2_select_009#>" onClick="return saveChanges()">
        &nbsp;
